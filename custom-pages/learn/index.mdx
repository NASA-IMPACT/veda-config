...
<Block>
  <Prose>
    ...
    <EventsComponent items={NEWS_ITEMS} itemType="news" />
...
<Block>
  <Prose>
    ## Events 
    <EventsComponent items={EVENT_ITEMS} itemType="event_items"/>
  </Prose>
</Block>
...
<Block>
  <Prose>
    ## Newsletters 
    <EventsComponent items={NEWSLETTER_ITEMS} itemType="newsletter" />
  </Prose>
</Block>
...
<Block>
  <Prose>
    ## Tutorial Videos 
    <EventsComponent items={TUTORIAL_ITEMS}  itemType="tutorials"/>
  </Prose>
</Block>

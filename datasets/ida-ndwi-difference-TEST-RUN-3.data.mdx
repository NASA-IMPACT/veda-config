---
id: ida-ndwi-difference-TEST-RUN-3
name: NDWI Difference for Pre and Post-Hurricane Ida from PlanetScope TEST-RUN-3
featured: false
...
infoDescription: "::markdown\n            - **Temporal Extent:** 2015 - 2100\n   \
  ...
  \ - **Data Type:** Research\n        "
layers:
- id: ida-ndwi-difference-TEST-RUN-3-cog_default
  stacCol: ida-ndwi-difference-TEST-RUN-3
  ...
  sourceParams:
    ...
    maxzoom: 4
  compare:
    datasetId: ida-ndwi-difference-TEST-RUN-3
    layerId: cog_default

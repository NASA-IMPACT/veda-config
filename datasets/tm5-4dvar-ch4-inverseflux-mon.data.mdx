...
usage:
  - url: 'https://github.com/US-GHG-Center/ghgc-docs/blob/main/cog_transformation_scripts/tm54dvar-ch4flux-monthgrid-v1_Transformation_Code.py'
...
layers:
  - id: total-ch4
    ...
    sourceParams:
      ...
      nodata: 0
    compare:
      datasetId: tm54dvar-ch4flux-month
      layerId: total-ch4
      mapLabel: |
...
<Block>
  <Prose>
    ...
    ## Data Stewardship
    - [Data Workflow](https://github.com/US-GHG-Center/ghgc-docs/blob/main/data_workflow/tm54dvar-ch4flux-monthgrid-v1_Data_Flow.png)
    - [Data Transformation Code](https://github.com/US-GHG-Center/ghgc-docs/blob/main/cog_transformation_scripts/tm54dvar-ch4flux-monthgrid-v1_Transformation_Code.py)
    - [U.S. GHG Center Data Intake Processing and Verification Report](https://github.com/US-GHG-Center/ghgc-docs/blob/main/processing_and_verification_reports/tm54dvar-ch4flux-monthgrid-v1_Processing%20and%20Verification%20Report.pdf)

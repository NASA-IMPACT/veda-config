...
usage:
  - url: 'https://github.com/US-GHG-Center/ghgc-docs/blob/main/cog_transformation/scripts/tm54dvar-ch4flux-monthgrid-v1_Transformation_Code.py'
    label:  Notebook showing data transformation to COG
    title: 'TM5-4DVar Isotopic CH₄ Inverse Fluxes data transformation notebook'
  - url: 'https://github.com/US-GHG-Center/ghgc-docs/blob/main/user_data_notebooks/tm54dvar-ch4flux-monthgrid-v1_User_Notebook.ipynb'
...
layers:
  - id: total-ch4
    stacCol: tm54dvar-ch4flux-monthgrid-v1
...
<Block>
  <Prose>
    ...
    - [Data Transformation Code](https://github.com/US-GHG-Center/ghgc-docs/blob/main/cog_transformation/scripts/tm54dvar-ch4flux-monthgrid-v1_Transformation_Code.py)

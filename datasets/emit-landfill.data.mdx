...
description: "Methane (CH4) point source plume complexes over Landfills in Dallas, TX and Stockton, CA on August 25, 2023 measured by the EMIT imaging spectrometer on the International Space Station (ISS)"
media:
  ...
  - id: landfill-emit
    ...
    legend:
      ...
      stops:
        ...
        - '#f7cf39'
  - id: emit-stockton
    stacCol: emit-stockton
    name: Stockton Methane (ppm m)
    type: raster
    description: "EMIT Methane (CH4) plumes in ppm m"
    initialDatetime: newest
    zoomExtent:

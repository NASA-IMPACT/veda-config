---
id: nighttime-lights
name: 'Black Marble Night Lights (Select Events)'
...
layers:
  - id: nightlights-hd-monthly-covid-19
    stacCol: nightlights-hd-monthly
    name: Black Marble Night Lights (COVID-19)
    type: raster
    description: 'Black Marble night lights imagery averaged over 1 month across major cities between 2019 and 2022'
    zoomExtent:
      - 8
      - 16
    sourceParams:
...
<Block>
  <Prose>   
    ## Dataset Details <br />(COVID-19 Night Lights)
    - **Temporal Extent:** January 1, 2019 - March 31, 2021<br />
    - **Spatial Extent:** Global<br />
    - **Spatial Resolution:** 10 meters<br />
...
<Figure>
    <Map
      ...
      dateTime='2020-08-01'
      zoom={10}
      center={[139.7006, 35.6648]}
    />
    <Caption
      attrAuthor='NASA'
      attrUrl='https://nasa.gov/'
    >
    Monthly averaged night-time lights over Tokyo, Japan in August 2020.
    </Caption>
  </Figure>
</Block>
...
<Block>
  <Prose>
  ## Dataset Details <br />(Derechos Night Lights)
...
<Block>
  <Prose>
  ## Dataset Details <br />(2024 Tornado Outbreak Night Lights)

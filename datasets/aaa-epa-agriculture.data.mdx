...
featuredOn:
  - covid-19
id: aaa-epa-agriculture
name: EPA - Agriculture
description: Emissions from agriculture include enteric fermentation, manure
  management, rice cultivation, and field burning of agricultural residues
thematics:
  - eis
media:
...
layers:
  ...
  - id: epa-annual-emissions_4a_enteric_fermentation
    ...
    type: raster
    description: Emissions from sector 4A from enteric fermentation (fermentation

---
id: ida-ndwi-difference-TEST
name: NDWI Difference for Pre and Post-Hurricane Ida from PlanetScope TEST
featured: false
...
infoDescription: "::markdown\n            - **Temporal Extent:** 2015 - 2100\n   \
  ...
  \ - **Data Type:** Research\n        "
layers:
- id: ida-ndwi-difference-TEST-cog_default
  stacCol: ida-ndwi-difference-TEST
  ...
  sourceParams:
    ...
    maxzoom: 4
  compare:
    datasetId: ida-ndwi-difference-TEST
    layerId: cog_default

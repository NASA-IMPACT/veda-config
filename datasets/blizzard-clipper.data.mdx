...
layers:
  - id: blizzard-clipper
    ...
    name: AB/SK/MB Clipper Snowfall Footprint
    type: raster
    description: "Land mask of the climatologically favored region of the USA and Canada that experiences snowfall from Alberta Clipper, Saskatchewan Screamer, and Manitoba Mauler cyclones."
...
<Block>
  ...
  <Figure>
    ...
    >
      Land mask of the climatologically favored region of the USA and Canada that experiences snowfall from Alberta Clipper, Saskatchewan Screamer, and Manitoba Mauler cyclones.
    </Caption>
  </Figure>
</Block>

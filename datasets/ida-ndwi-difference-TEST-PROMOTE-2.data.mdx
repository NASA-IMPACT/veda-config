---
id: ida-ndwi-difference-TEST-PROMOTE-2
name: NDWI Difference for Pre and Post-Hurricane Ida from PlanetScope TEST-PROMOTE-2
featured: false
description: Normalized Difference Water Index Difference of before and after Hurricane
  Ida in Southern Louisiana. TEST-2
media:
...
infoDescription: "::markdown\n            - **Temporal Extent:** 2015 - 2100\n   \
  ...
  \ - **Data Type:** Research\n        "
layers:
- id: ida-ndwi-difference-TEST-PROMOTE-2-cog_default
  stacCol: ida-ndwi-difference-TEST-PROMOTE-2
  ...
  sourceParams:
    ...
    maxzoom: 4
  compare:
    datasetId: ida-ndwi-difference-TEST-PROMOTE-2
    layerId: cog_default

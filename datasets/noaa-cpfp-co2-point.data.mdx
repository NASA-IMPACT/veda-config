...
<Block>
  <Prose>
    ...
    **Data Latency:** Updated annually
    ...
    This dataset contains CO₂ concentration measurements in units of parts per million (ppm) made from surface in-situ and tower sites and from surface flask air samples. The surface in-situ and tower instrumentation measures CO2 continuously (hourly) while the flask air samples are non-continuous measurements (frequency varies by station). Due to the high data volume of hourly tower measurements, daily and monthly averages are generated for display in the US GHG Center.

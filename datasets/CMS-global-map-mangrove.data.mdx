...
layers:
  - id: CMS-global-map-mangrove
    type: cmr
    stacCol: CMS-global-map-mangrove
    ...
    sourceParams:
      ...
      rescale:
        ...
        - 46
      maxzoom: 12
      concept_id: C2389107206-ORNL_CLOUD
      backend: rasterio
    legend:
      unit:
        label:

...
Citation of source dataset as specified by the data provider.
    
## Dataset Accuracy
Brief summary of dataset accuracy.
...
Add any additional dataset-specific disclaimer/caveat text here. This could pertain to intended use of the data, an indication of provisional data, or additional data that can be found at the source but not included in VEDA.   
...
Citations in APA format (no need to spell out full author first names here) for any other relevant related publications. This includes papers with significant use of the data or a validation paper, or any other misc. relevant documents. 
List these in alphabetical order and add a space between citations. 

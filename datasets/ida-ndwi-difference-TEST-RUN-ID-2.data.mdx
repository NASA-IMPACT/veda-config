---
id: ida-ndwi-difference-TEST-RUN-ID-2
name: NDWI Difference for Pre and Post-Hurricane Ida from PlanetScope TEST-RUN-ID-2
featured: false
...
infoDescription: "::markdown\n            - **Temporal Extent:** 2015 - 2100\n   \
  ...
  \ - **Data Type:** Research\n        "
layers:
- id: ida-ndwi-difference-TEST-RUN-ID-2-cog_default
  stacCol: ida-ndwi-difference-TEST-RUN-ID-2
  ...
  sourceParams:
    ...
    maxzoom: 4
  compare:
    datasetId: ida-ndwi-difference-TEST-RUN-ID-2
    layerId: cog_default

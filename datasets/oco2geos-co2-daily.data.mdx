---
id: oco2geos-co2-daygrid-v10r-ghgc
name: OCO-2 GEOS Assimilated CO₂ Concentrations
description: Daily, global 0.5 x 0.625 degree assimilated CO₂ concentrations derived from OCO-2 satellite data, version 10r
usage:
  - url: 'https://github.com/US-GHG-Center/ghgc-docs/blob/main/cog_transformation/scripts/oco2geos-co2-daygrid-v10r_Transformation_Code.py'
    label:  Notebook showing data transformation to COG
    title: 'OCO-2 GEOS CO₂ data transformation notebook'
  - url: 'https://github.com/US-GHG-Center/ghgc-docs/blob/main/user_data_notebooks/oco2geos-co2-daygrid-v10r_User_Notebook.ipynb'
    label: Notebook to read, visualize, and explore data statistics
    title: 'OCO-2 GEOS CO₂ data notebook'
...
layers:
  - id: oco2-dryair-column
    ...
    sourceParams:
      ...
      nodata: 0
    compare:
      datasetId: oco2geos-co2-daygrid-v10r-ghgc
    ...
    legend:
      ...
      stops:
        ...
        - '#f1605d'
        - '#feb078'
  - id: oco2-dryair-column-prec
    stacCol: oco2geos-co2-daygrid-v10r
    name: Average Dry-Air Column CO₂ Precision (XCO₂PREC)
    type: raster
    ...
    compare:
      datasetId: oco2geos-co2-daygrid-v10r-ghgc
      layerId: oco2-dryair-column-prec
      mapLabel: |
        ::js ({ dateFns, datetime, compareDatetime }) => {
          return `${dateFns.format(datetime, 'LLL yyyy')} VS ${dateFns.format(compareDatetime, 'LLL yyyy')}`;
        }
...
<Block>
  <Prose>
    ...
    Users should understand that during Arctic and Antarctic nights, there is no observational coverage from OCO-2. Nevertheless, with gap-filling, it is possible for the assimilation to inform regions without sunlight. 
    ...
    Ott, L. and Weir, B. (2022). OCO-2 GEOS L3 XCO2 Product User’s Guide. GES DISC. [https://docserver.gesdisc.eosdis.nasa.gov/public/project/OCO/OCO2_GEOS_L3_User_Guide.pdf](https://docserver.gesdisc.eosdis.nasa.gov/public/project/OCO/OCO2_GEOS_L3_User_Guide.pdf)
    ...
    Morgan, K. and Savtchenko, A. (2022). README Document for OCO-2 GEOS L3 XCO2 Products. GES DISC. [https://docserver.gesdisc.eosdis.nasa.gov/public/project/OCO/README_OCO2_GEOS.pdf](https://docserver.gesdisc.eosdis.nasa.gov/public/project/OCO/README_OCO2_GEOS.pdf)
    ...
    ## Data Stewardship
    - [Data Workflow](https://github.com/US-GHG-Center/ghgc-docs/blob/main/data_workflow/media/oco2geos-co2-daygrid-v10r_Data_Flow.png)
    - [Data Transformation Code](https://github.com/US-GHG-Center/ghgc-docs/blob/main/cog_transformation/scripts/oco2geos-co2-daygrid-v10r_Transformation_Code.py)
    - [U.S. GHG Center Data Intake Processing and Verification Report](https://github.com/US-GHG-Center/ghgc-docs/blob/main/processing_and_verification_reports/reports/oco2geos-co2-daygrid-v10r_Processing%20and%20Verification%20Report.pdf)

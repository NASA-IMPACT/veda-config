...
import StacCollectionMap from '../components/StacCollectionMap.tsx'; 
...
<Figure>
    <StacCollectionMap
      collectionId="bangladesh-landcover-2001-2020"
      stacUrl="https://openveda.cloud/api/stac"
      tilerUrl="https://openveda.cloud/api/raster"
      height={500}
    />
  </Figure>
</Block>

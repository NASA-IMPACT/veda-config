...
layers:
  ...
  - id: microbial-ch4
    ...
    info:
      ...
      unit: Grams of methane per square meter per year (g CH₄/m²/year)         
    media:
      src: ::file ./tm54dvar-ch4flux-monthgrid-v1.thumbnails.microbial.png
  ...
  - id: fossil-ch4
    ...
    info:
      ...
      unit: Grams of methane per square meter per year (g CH₄/m²/year)         
    media:
      src: ::file ./tm54dvar-ch4flux-monthgrid-v1.thumbnails.fossil.png
  ...
  - id: pyrogenic-ch4
    ...
    info:
      ...
      unit: Grams of methane per square meter per year (g CH₄/m²/year)         
    media:
      src: ::file ./tm54dvar-ch4flux-monthgrid-v1.thumbnails.pyrogenic.png

...
description: Total and wetland yearly methane emissions derived using the GEOS-Chem global chemistry transport model with inclusion of GOSAT data for 2010 to 2022 on a 5x4 degree (lon/lat) grid 
usage:
...
<Block>
  <Prose>
    ...
    **Temporal Resolution:** Annual   
    **Spatial Extent:** Global    
    **Spatial Resolution:** 5°(longitude) x 4°(latitude)  

...
layers:
  ...
  - id: post-wetland-id
    ...
    type: raster
    description: Posterior Wetlands
    basemapId: 'light'
    zoomExtent:
      - 0
      - 20
  ...
  - id: prior-wetland-uncertainty-id
    ...
    type: raster
    description: Priori Wetlands Uncertainty
    basemapId: 'light'
    zoomExtent:
      - 0
      - 20
  ...
  - id: post-wetland-uncertainty-id
    ...
    type: raster
    description: Posterior Wetlands Uncertainty
    basemapId: 'light'
    zoomExtent:
      - 0
      - 20

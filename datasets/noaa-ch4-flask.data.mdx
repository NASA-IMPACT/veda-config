---
id: noaa-ch4-flask
name: Atmospheric Methane Concentrations from the NOAA Global Monitoring Laboratory, 1983-2022
description: Atmospheric concentrations of methane (CH₄) from flask air samples collected over time at specific locations
media:
...
<Block type='wide'>
  <Prose>
    ...
    - **Data Units:** 10<sup>-9</sup> moles of CH₄ per mole of dry air = nanomol/mol (nmol/mol)
    - **Data Type:** 
    - **Data Latency:** 

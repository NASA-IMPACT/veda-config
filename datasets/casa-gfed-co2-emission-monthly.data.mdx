...
usage:
  - url: 'https://github.com/NASA-IMPACT/GHGC_docs/blob/main/cog_transformation_scripts/NASA-IMPACT/GHGC_docs/cog_transformation_scripts/GEOSCarb_CASAGFED_netcdf_to_cog.py'

---
id: casagfed-carbonflux-monthgrid-v3-ghgc
...
usage:
  - url: 'https://github.com/US-GHG-Center/ghgc-docs/blob/main/cog_transformation/scripts/casagfed-carbonflux-monthgrid-v3_Transformation_Code.py'
    label: Notebook to transform netcdf to COG
    title: 'CASA-GFED3 carbon flux data transformation notebook'
  - url: 'https://github.com/US-GHG-Center/ghgc-docs/blob/main/user_data_notebooks/casagfed-carbonflux-monthgrid-v3_User_Notebook.ipynb'
...
layers:
  - id: casa-gfed-co2-flux
    ...
    sourceParams:
      ...
      nodata: 0
    compare:
      datasetId: casagfed-carbonflux-monthgrid-v3-ghgc
...
<Block>
  <Prose>
    ...
    ## Data Stewardship
    - [Data Workflow](https://github.com/US-GHG-Center/ghgc-docs/blob/main/data_workflow/media/casagfed-carbonflux-monthgrid-v3_Data_Flow.png)
    - [Data Transformation Code](https://github.com/US-GHG-Center/ghgc-docs/blob/main/cog_transformation/scripts/casagfed-carbonflux-monthgrid-v3_Transformation_Code.py)
    - [U.S. GHG Center Data Intake Processing and Verification Report](https://github.com/US-GHG-Center/ghgc-docs/blob/main/processing_and_verification_reports/reports/casagfed-carbonflux-monthgrid-v3_Processing%20and%20Verification%20Report.pdf)
  </Prose>
</Block>

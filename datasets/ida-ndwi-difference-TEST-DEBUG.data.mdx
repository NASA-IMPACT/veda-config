---
id: ida-ndwi-difference-TEST-DEBUG
name: NDWI Difference for Pre and Post-Hurricane Ida from PlanetScope TEST-DEBUG
featured: false
...
infoDescription: "::markdown\n            - **Temporal Extent:** 2015 - 2100\n   \
  ...
  \ - **Data Type:** Research\n        "
layers:
- id: ida-ndwi-difference-TEST-DEBUG-cog_default
  stacCol: ida-ndwi-difference-TEST-DEBUG
  ...
  sourceParams:
    ...
    maxzoom: 4
  compare:
    datasetId: ida-ndwi-difference-TEST-DEBUG
    layerId: cog_default

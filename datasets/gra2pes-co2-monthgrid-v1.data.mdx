...
description: Monthly, 0.036 degree resolution emissions of carbon dioxide (CO₂), carbon monoxide (CO), nitrogen oxide (NOₓ), sulfur dioxide (SO₂), and particulate matter (PM₂.₅) emissions for the year 2021 over the Contiguous United States from the Greenhouse gas And Air Pollutants Emissions System (GRA²PES)
usage:
  - url: "https://us-ghg-center.github.io/ghgc-docs/pr-preview/pr-123/cog_transformation/gra2pes-ghg-monthgrid-v1.html"
...
infoDescription: |
  ::markdown
    ...
    - Data Units: Metric tons per kilometer squared per month (tonne/km²/month) for carbon dioxide (ffCO₂), carbon monoxide (CO), nitrogen oxides (NOₓ), sulfur dioxide (SO₂), and particulate matter (PM₂.₅)
    - Data Type: Research
...
<Figure style={{ display: 'block' }}>
  <div className='dataset-comparison'>
    ...
    - <Link to="/stories/gra2pes">Learn more </Link>about how GRA2PES combines GHG and air quality pollution sources into a single useful research database
    ...
    ## Data Stewardship
    - [Data Workflow](https://us-ghg-center.github.io/ghgc-docs/pr-preview/pr-123/data_workflow/gra2pes-ghg-monthgrid-v1_Data_Flow.html)
    - [Data Transformation Code](https://us-ghg-center.github.io/ghgc-docs/pr-preview/pr-123/cog_transformation/gra2pes-ghg-monthgrid-v1.html)
    - [US GHG Center Data Intake Processing and Verification Report](https://us-ghg-center.github.io/ghgc-docs/pr-preview/pr-123/processing_and_verification_reports/gra2pes-ghg-monthgrid-v1_Processing%20and%20Verification%20Report.html)

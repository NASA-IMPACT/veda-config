...
infoDescription: |
  ::markdown
    ...
    - Data Type: Research
    - Data Latency: Updated several times per year
...
<Block>
  <Prose>
    ...
    The daily and monthly low latency datasets listed indicate the data delivered more frequently throughout the year using estimated carbon dioxide input data. The daily and monthly higher quality “final” datasets are delivered annually and replace the low latency data. 

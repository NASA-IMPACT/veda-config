...
featuredOn:
  - air-quality
id: so2-for-test
name: Sulfur Dioxide Test
description: NASA OMI/Aura Sulfur Dioxide (SO2) Total Column Test
thematics: air-quality
media:
  src: ::file ./so2--dataset-cover.jpg
  alt: 2018 Social Vulnerability Index (SVI) based on minority status and language
    score.
  author:
    name: NASA
    url: https://nasa.gov

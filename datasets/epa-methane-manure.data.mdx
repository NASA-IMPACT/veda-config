  ...
  - id: rice-cultivation-l
    ...
    legend:
      ...
      stops:
        ...
        - "#521A13"
    media:
      src: https://github.com/US-GHG-Center/veda-config-ghg/blob/develop/datasets/epa-ch4emission-yeargrid-v2express.thumbnails.agriculture.rice.cultivation.annual.png

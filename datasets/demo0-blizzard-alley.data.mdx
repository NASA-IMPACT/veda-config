---
id: demo0-blizzard-alley
name: DEMO 0 Blizzard Alley
featured: false
description: Single value raster displaying the region of the USA known as Blizzard
  Alley, where at least 10-20 blizzards have occurred since 1950. Eastern North Dakota
  seen 50-100+ in the same time period.
media:
...
infoDescription: "::markdown\n            - **Temporal Extent:** 2015 - 2100\n   \
  ...
  \ - **Data Type:** Research\n        "
layers:
- id: demo0-blizzard-alley-cog_default
  stacCol: demo0-blizzard-alley
  ...
  sourceParams:
    ...
    maxzoom: 4
  compare:
    datasetId: demo0-blizzard-alley
    layerId: cog_default

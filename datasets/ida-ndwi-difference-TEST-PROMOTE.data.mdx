---
id: ida-ndwi-difference-TEST-PROMOTE
name: NDWI Difference for Pre and Post-Hurricane Ida from PlanetScope TEST-PROMOTE
featured: false
...
infoDescription: "::markdown\n            - **Temporal Extent:** 2015 - 2100\n   \
  ...
  \ - **Data Type:** Research\n        "
layers:
- id: ida-ndwi-difference-TEST-PROMOTE-cog_default
  stacCol: ida-ndwi-difference-TEST-PROMOTE
  ...
  sourceParams:
    ...
    maxzoom: 4
  compare:
    datasetId: ida-ndwi-difference-TEST-PROMOTE
    layerId: cog_default

...
featured: false
description: "Single value raster displaying the general snowfall footprint of a Nor\u2019\
  easter type of mid-latitude cyclone."
media:
...
infoDescription: "::markdown\n            - **Temporal Extent:** 2015 - 2100\n   \
  ...
  \ - **Data Type:** Research\n        "
layers:
- id: blizzard-noreaster-cog_default

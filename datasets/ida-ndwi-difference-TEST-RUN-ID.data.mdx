---
id: ida-ndwi-difference-TEST-RUN-ID
name: NDWI Difference for Pre and Post-Hurricane Ida from PlanetScope TEST-RUN-ID
featured: false
...
infoDescription: "::markdown\n            - **Temporal Extent:** 2015 - 2100\n   \
  ...
  \ - **Data Type:** Research\n        "
layers:
- id: ida-ndwi-difference-TEST-RUN-ID-cog_default
  stacCol: ida-ndwi-difference-TEST-RUN-ID
  ...
  sourceParams:
    ...
    maxzoom: 4
  compare:
    datasetId: ida-ndwi-difference-TEST-RUN-ID
    layerId: cog_default

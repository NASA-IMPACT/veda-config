...
<Block>
  ...
  Visit the [ISRIC](https://www.isric.org) webpage to explore all of the data options that ISRIC offers.
...
<Block>
  ...
  International Soil Reference and Information Centre (ISRIC). (2017). ISRIC Soil Texture Classification: Global Soil Properties. https://www.isric.org

...
id: co2-test
name: Carbon Dioxide
description: The Impact of the COVID-19 Pandemic on Atmospheric CO2 test
thematics:
  - air-quality
  - eis
media:
...
layers:
  - sourceParams:
    ...
    type: raster
    id: co2-mean
    description: The average background concentration of carbon dioxide (CO₂) in our
      atmosphere.
    stacCol: co2-mean
    zoomExtent:
      - 0
  ...
  - sourceParams:
    ...
    type: raster
    id: co2-diff
    description: The changes in carbon dioxide (CO₂) levels in our atmosphere versus
      previous years.
    stacCol: co2-diff
    zoomExtent:
      - 0

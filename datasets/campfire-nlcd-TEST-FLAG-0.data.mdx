---
id: campfire-nlcd-TEST-FLAG-0
name: 'Camp Fire Domain: Land Cover TEST FLAG-0'
featured: false
...
infoDescription: "::markdown\n            - **Temporal Extent:** 2015 - 2100\n   \
  ...
  \ - **Data Type:** Research\n        "
layers:
- id: campfire-nlcd-TEST-FLAG-0-cog_default
  stacCol: campfire-nlcd-TEST-FLAG-0
  ...
  sourceParams:
    ...
    maxzoom: 4
  compare:
    datasetId: campfire-nlcd-TEST-FLAG-0
    layerId: cog_default

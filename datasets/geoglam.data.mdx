...
description: Open, timely, science-driven information on crop conditions, change
media:
...
layers:
  - sourceParams:
      colormap: '{"1": [120, 120, 120], "2": [130, 65, 0], "3": [66, 207, 56], "4":
        [245, 239, 0], "5": [241, 89, 32], "6": [168, 0, 0], "7": [0, 143,
        201]}'
      bidx: 1
      unscale: false
      resampling: nearest
    ...
    type: raster
    id: geoglam
    description: Combined crop conditions across both the Crop Monitor for AMIS and

---
id: methane-farms
name: "Methane Emissions 2020 - Manure Management"
description: "Gridded Methane Emissions - 2020 Manure Management"
media:
...
layers:
  - id: methane-farms
    stacCol: methane-farms
    name: Methane Emissions (mol m^-2 s^-1)
    type: raster
    description: "Gridded Methane Emission data for 2020. Quantifies methane in unites of mol per sq. meter per sec. Measurement of the flux methane into atmosphere from different anthropogenic sources. For this case, measures methane from manure management."
    initialDatetime: oldest
    zoomExtent:
      - 0
      - 20
    sourceParams:

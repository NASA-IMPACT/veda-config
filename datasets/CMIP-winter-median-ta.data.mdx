...
layers:
  - id: CMIP245-winter-median-ta
    ...
    name: 'Percent-change to winter average air temperature, SSP2-4.5'
    type: raster
    description: 'Percent difference in projected winter (January, February, March) average air temperature, relative to a historical timeframe between 1995 and 2014. Outputs represent the median of 23 member ensembles from CMIP6 (SSP 2-4.5) with downscaling performed by NASA Earth Exchange'
    sourceParams:
      resampling: bilinear
      bidx: 1
  ...
  - id: CMIP585-winter-median-ta
    ...
    name: 'Percent-change to winter average air temperature, SSP5-8.5'
    type: raster
    description: 'Percent difference in projected winter (January, February, March) average air temperature, relative to a historical timeframe between 1995 and 2014. Outputs represent the median of 23 member ensembles from CMIP6 (SSP 5-8.5) with downscaling performed by NASA Earth Exchange'
    sourceParams:
      resampling: bilinear
      bidx: 1
      colormap_name: rdbu_r

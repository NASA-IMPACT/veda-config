---
id: la-fires-parcels
name: ASSR Parcel Damage - Eaton and Palisades Fires (2025)
featured: false
description: Parcel maps within the Eaton and Palisades Fires mapping the level of
  destruction to buildings on those respective parcels.
media:
...
infoDescription: "::markdown\n            - **Temporal Extent:** 2015 - 2100\n   \
  ...
  \ - **Data Type:** Research\n        "
layers:
- id: la-fires-parcels-cog_default

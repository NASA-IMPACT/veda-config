...
description: "This dataset characterizes the relative levels of multidimensional deprivation and poverty. GRDIv1 is built from sociodemographic and satellite data inputs that were spatially harmonized, indexed, and weighted into six main components to produce the final index raster."
media:

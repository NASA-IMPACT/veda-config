...
<Block>
  ...
  The data are available as GEOTiff raster format for the Global Gridded Relative Deprivation Index (GRDI), v1 from the [web page](https://alpha.sedac.ciesin.columbia.edu/data/set/povmap-grdi-v1) (not active)

  Dataset Description and documentation accessible at: Center for International Earth Science Information Network - CIESIN - Columbia University. 2022. Documentation for the Global Gridded Relative Deprivation Index (GRDI), v1. Palisades, NY: NASA Socioeconomic Data and Applications Center (SEDAC). https://doi.org/10.7927/xwf1-k532 (link not active). Accessed 29 June 2022.

---
id: lis-tws-anomaly
name: Terrestrial Water Storage (TWS) Anomalies
featured: false
description: Anomalies in Terrestrial Water Storage (TWS) modeled using LIS framework
  by assimilating GRACE TWS, soil moisture, and leaf area index over 2001-2021.
media:

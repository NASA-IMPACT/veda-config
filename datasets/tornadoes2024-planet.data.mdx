...
<Block>
  ...
  Visit Planet's [home page](https://www.planet.com) to explore options for data access. This datawas made available through the NASA [Commercial Satellite Data Acquisition (CSDA) Program](https://earthdata.nasa.gov/about/csda/vendor-planet). You can access the CDSA data explorer [**HERE**](https://csdap.earthdata.nasa.gov).

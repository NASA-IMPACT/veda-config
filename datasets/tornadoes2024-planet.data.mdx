...
layers:
  ...
  - id: ps-tornadoes-2024-difference
    ...
    type: raster
    description: 'Commercial SmallSat Planet Satellite Imagery differnece of tornado damage at Greenfield, Iowa in the spring 2024 tornado season.'
    zoomExtent:
      - 0
      - 20
    sourceParams:
...
<Figure>
  <Map
    ...
    zoom={13.5}
    datasetId='ps-lakeview-winchester-tornadoes-2024'

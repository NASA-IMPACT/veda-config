...
featured: false
description: TrueColor RGB commercial satellite imagery from Planet Labs of the Eaton
  Fire on January 9, 2025 north of Los Angeles, CA. This data was made available through
  the NASA Commercial Satellite Data Acquisition (CSDA) Program
media:
...
infoDescription: "::markdown\n            - **Temporal Extent:** 2015 - 2100\n   \
  ...
  \ - **Data Type:** Research\n        "
layers:
- id: la-fires-planet-cog_default

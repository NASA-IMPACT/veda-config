...
<Block>
  <Prose>   
    ## Dataset Details <br />(Houston, TX AOD)
...
<Block>
  <Prose>
    ## Dataset Details <br />(Houston, TX AOD Difference)
    - **Temporal Extent:** 2000-2019<br />
  ...
  <Figure>
    <Map
      ...
      />
    <Caption>
      Aerosol Optical Depth Compared Decadally from 2000-2009 & 2010-2019 vs the Urbanization of the Houston metro from 2000-2019. The left portion of the map shows the subtracted difference in AOD over the last 20 years over the Houston metropolitan area.
    </Caption>
  </Figure>
</Block>
...
<Block>
  <Prose>
  ## Dataset Details <br />(Derecho AOD)

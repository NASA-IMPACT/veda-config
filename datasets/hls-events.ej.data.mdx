...
usage:
  url: "https://veda-analytics.delta-backend.com/hub/user-redirect/git-pull?repo=https://github.com/NASA-IMPACT/veda-documentation&urlpath=lab/tree/veda-documentation/hls-visualization.ipynb&branch=ab/remove-numbers"

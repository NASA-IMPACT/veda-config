...
name: CarbonTracker-CH4 Isotopic Methane Inverse Fluxes
...
usage:
  ...
  - url: https://dljsq618eotzp.cloudfront.net/browseui/index.html#ct-ch4-monthgrid-v2023/
...
<Block>
  <Prose>
    ...
    CarbonTracker CT-CH4-2023 results provided by NOAA GML, Boulder, Colorado, USA from the website at [http://dx.doi.org/10.25925/40jt-qd67](http://dx.doi.org/10.25925/40jt-qd67) 

...
name: "MERRA2 Reanalysis \u2013 10 Meter Wind (Select Events)"
featured: false
description: MERRA2 10-meter wind speeds global reanalysis for three select blizzard
  events.
media:
...
infoDescription: "::markdown\n            - **Temporal Extent:** 2015 - 2100\n   \
  ...
  \ - **Data Type:** Research\n        "
layers:
- id: blizzard-merra2-10m-wind-cog_default

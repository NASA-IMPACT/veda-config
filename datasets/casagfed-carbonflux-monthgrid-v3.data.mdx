...
layers:
  - id: casa-gfed-co2-flux
    ...
    info:
      ...
      latency: Monthly
      unit: Kilograms of carbon per square meter per month (kg Carbon/m²/mon)
    media:
      src: ::file ./casagfed-carbonflux-monthgrid-v3.thumbnails.npp.png
      alt: Rendered Net Primary Production (NPP)
  - id: casa-gfed-co2-flux-hr
    ...
    info:
      ...
      unit: Kilograms of carbon per square meter per month (kg Carbon/m²/mon)
    media:
      src: ::file ./casagfed-carbonflux-monthgrid-v3.thumbnails.rh.png
      alt: Rendered Heterotrophic Respiration (Rh)
  - id: casa-gfed-co2-flux-nee
    ...
    info:
      ...
      unit: Kilograms of carbon per square meter per month (kg Carbon/m²/mon)
    media:
      src: ::file ./casagfed-carbonflux-monthgrid-v3.thumbnails.nee.png
      alt: Rendered Net Ecosystem Exchange (NEE)
  - id: casa-gfed-co2-flux-fe
    ...
    info:
      ...
      unit: Kilograms of carbon per square meter per month (kg Carbon/m²/mon)
    media:
      src: ::file ./casagfed-carbonflux-monthgrid-v3.thumbnails.fire.png
      alt: Rendered Fire Emissions (FIRE)
  - id: casa-gfed-co2-flux-fuel
    ...
    info:
      ...
      unit: Kilograms of carbon per square meter per month (kg Carbon/m²/mon)
    media:
      src: ::file ./casagfed-carbonflux-monthgrid-v3.thumbnails.fuel.png
      alt: Rendered Wood Fuel Emissions (FUEL)
---

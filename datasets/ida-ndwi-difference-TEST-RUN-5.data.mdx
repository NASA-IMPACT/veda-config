---
id: ida-ndwi-difference-TEST-RUN-5
name: NDWI Difference for Pre and Post-Hurricane Ida from PlanetScope TEST-RUN-5
featured: false
...
infoDescription: "::markdown\n            - **Temporal Extent:** 2015 - 2100\n   \
  ...
  \ - **Data Type:** Research\n        "
layers:
- id: ida-ndwi-difference-TEST-RUN-5-cog_default
  stacCol: ida-ndwi-difference-TEST-RUN-5
  ...
  sourceParams:
    ...
    maxzoom: 4
  compare:
    datasetId: ida-ndwi-difference-TEST-RUN-5
    layerId: cog_default

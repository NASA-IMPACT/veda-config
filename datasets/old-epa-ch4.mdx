...
usage:
  - url: 'https://github.com/NASA-IMPACT/GHGC_docs/blob/main/cog_transformation/epa_methane_nc_transformation.py'
...
<Block>
  <Prose>
    ...
    ## Data Stewardship
    - [Data Workflow]
    - [Data Transformation Code](https://github.com/NASA-IMPACT/GHGC_docs/blob/main/cog_transformation/NASA_GSFC_wetlands_transformation.py)

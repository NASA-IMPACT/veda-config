---
id: campfire-nlcd-TEST-CHANGE
name: 'Camp Fire Domain: Land Cover TEST CHANGE'
featured: false
...
infoDescription: "::markdown\n            - **Temporal Extent:** 2015 - 2100\n   \
  ...
  \ - **Data Type:** Research\n        "
layers:
- id: campfire-nlcd-TEST-CHANGE-cog_default
  stacCol: campfire-nlcd-TEST-CHANGE
  ...
  sourceParams:
    ...
    maxzoom: 4
  compare:
    datasetId: campfire-nlcd-TEST-CHANGE
    layerId: cog_default

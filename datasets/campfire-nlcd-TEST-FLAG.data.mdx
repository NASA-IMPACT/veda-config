---
id: campfire-nlcd-TEST-FLAG
name: 'Camp Fire Domain: Land Cover TEST FLAG'
featured: false
...
infoDescription: "::markdown\n            - **Temporal Extent:** 2015 - 2100\n   \
  ...
  \ - **Data Type:** Research\n        "
layers:
- id: campfire-nlcd-TEST-FLAG-cog_default
  stacCol: campfire-nlcd-TEST-FLAG
  ...
  sourceParams:
    ...
    maxzoom: 4
  compare:
    datasetId: campfire-nlcd-TEST-FLAG
    layerId: cog_default

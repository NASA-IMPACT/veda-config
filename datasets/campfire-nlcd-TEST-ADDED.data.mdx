---
id: campfire-nlcd-TEST-ADDED
name: 'Camp Fire Domain: Land Cover TEST ADDED'
featured: false
...
infoDescription: "::markdown\n            - **Temporal Extent:** 2015 - 2100\n   \
  ...
  \ - **Data Type:** Research\n        "
layers:
- id: campfire-nlcd-TEST-ADDED-cog_default
  stacCol: campfire-nlcd-TEST-ADDED
  ...
  sourceParams:
    ...
    maxzoom: 4
  compare:
    datasetId: campfire-nlcd-TEST-ADDED
    layerId: cog_default

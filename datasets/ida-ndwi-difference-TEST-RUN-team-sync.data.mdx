---
id: ida-ndwi-difference-TEST-RUN-team-sync
...
infoDescription: "::markdown\n            - **Temporal Extent:** 2015 - 2100\n   \
  ...
  \ - **Data Type:** Research\n        "
layers:
- id: ida-ndwi-difference-TEST-RUN-team-sync-cog_default
  stacCol: ida-ndwi-difference-TEST-RUN-team-sync
  ...
  sourceParams:
    ...
    maxzoom: 4
  compare:
    datasetId: ida-ndwi-difference-TEST-RUN-team-sync
    layerId: cog_default

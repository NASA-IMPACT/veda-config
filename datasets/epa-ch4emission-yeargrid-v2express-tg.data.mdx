---
id: epa-ch4emission-yeargrid-v2express-tg-km
name: Gridded Anthropogenic Methane Emissions Inventory (Tg/km2/yr)
...
layers:
  - id: total-methane
    stacCol: epa-ch4emission-yeargrid-v2express-tg-km
    ...
    sourceParams:
      ...
      nodata: -9999
    compare:
      datasetId: epa-ch4emission-yeargrid-v2express-tg-km
...
<Block type='wide'>
  <Prose>
    ...
    **Data Version Details:**
    ...
    - **Data Units:** Billion molecules of methane per square centimeter per second (Tg/km2/yr)    

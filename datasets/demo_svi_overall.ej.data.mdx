---
id: demo-svi-overall
name: 'Demo - Overall Social Vulnerability'
...
layers:
  - id: demo-social-vulnerability-index-overall
    stacCol: demo-social-vulnerability-index-overall
    name: (Demo) Overall Social Vulnerability - Percentile Ranking
    type: raster
    ...
    sourceParams:
      ...
      rescale:
        ...
        - 1
    compare:
      datasetId: demo-svi-overall
      layerId: demo-social-vulnerability-index-overall
      mapLabel: |

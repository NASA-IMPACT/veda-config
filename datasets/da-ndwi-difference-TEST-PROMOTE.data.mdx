---
id: da-ndwi-difference-TEST-PROMOTE
...
infoDescription: "::markdown\n            - **Temporal Extent:** 2015 - 2100\n   \
  ...
  \ - **Data Type:** Research\n        "
layers:
- id: da-ndwi-difference-TEST-PROMOTE-cog_default
  stacCol: da-ndwi-difference-TEST-PROMOTE
  ...
  sourceParams:
    ...
    maxzoom: 4
  compare:
    datasetId: da-ndwi-difference-TEST-PROMOTE
    layerId: cog_default

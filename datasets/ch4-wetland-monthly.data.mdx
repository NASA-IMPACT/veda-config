...
usage:
  - url: 'https://us-ghg-center.github.io/ghgc-docs/cog_transformation/lpjwsl-wetlandch4-daygrid-v1.html'
    label:  Notebook showing data transformation to COG
    title: 'Wetlands CH₄ emissions data transformation notebook - daily'
  - url: 'https://us-ghg-center.github.io/ghgc-docs/cog_transformation/lpjwsl-wetlandch4-monthgrid-v1.html'
    label:  Notebook showing data transformation to COG
    title: 'Wetlands CH₄ emissions data transformation notebook - monthly'

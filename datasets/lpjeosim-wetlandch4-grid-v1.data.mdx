...
<Block>
  <Prose>
    <div style={{ border: '2px solid black', padding: '10px', display: 'inline-block', color: 'black', backgroundColor: '#d4f1f9' }}>
      ...
      Due to issues with the ERA5 driver, LPJ-EOSIM ERA5 and ensemble mean estimates of wetland methane have been revised as of November 14, 2024, effective from July 1, 2024. If data was obtained prior to November 14, 2024, we recommend re-downloading data from July 1, 2024 onward.
    </div>
...
<Block>
  <Prose>
    ...
    ## Version History
    Notice: Due to issues with the ERA5 driver, LPJ-EOSIM ERA5 and ensemble mean estimates of wetland methane have been revised as of November 14, 2024, effective from July 1, 2024. If data was obtained prior to November 14, 2024, we recommend re-downloading data from July 1, 2024 onward.
    ...
    - Model updates and improvements, including improved data latency with more regular updates and driver-specific model recalibrationDue

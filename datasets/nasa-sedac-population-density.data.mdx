...
usage:
  - url: 'https://github.com/NASA-IMPACT/GHGC_docs/blob/main/cog_transformation_scripts/nasa_sedac_tiff_transformation.py'
    label: Notebook to transform TIFF to COG
    title: 'SEDAC data transformation notebook'
  - url: 'https://github.com/NASA-IMPACT/GHGC_docs/blob/main/user_data_notebooks/sedac_population.ipynb'

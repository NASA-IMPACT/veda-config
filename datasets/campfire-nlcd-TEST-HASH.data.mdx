---
id: campfire-nlcd-TEST-HASH
name: 'Camp Fire Domain: Land Cover TEST HASH'
featured: false
...
infoDescription: "::markdown\n            - **Temporal Extent:** 2015 - 2100\n   \
  ...
  \ - **Data Type:** Research\n        "
layers:
- id: campfire-nlcd-TEST-HASH-cog_default
  stacCol: campfire-nlcd-TEST-HASH
  ...
  sourceParams:
    ...
    maxzoom: 4
  compare:
    datasetId: campfire-nlcd-TEST-HASH
    layerId: cog_default

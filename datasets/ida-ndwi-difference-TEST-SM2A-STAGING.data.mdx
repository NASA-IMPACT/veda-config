---
id: ida-ndwi-difference-TEST-SM2A-STAGING
name: NDWI Difference for Pre and Post-Hurricane Ida from PlanetScope TEST-SM2A-STAGING
featured: false
...
infoDescription: "::markdown\n            - **Temporal Extent:** 2015 - 2100\n   \
  ...
  \ - **Data Type:** Research\n        "
layers:
- id: ida-ndwi-difference-TEST-SM2A-STAGING-cog_default
  stacCol: ida-ndwi-difference-TEST-SM2A-STAGING
  ...
  sourceParams:
    ...
    maxzoom: 4
  compare:
    datasetId: ida-ndwi-difference-TEST-SM2A-STAGING
    layerId: cog_default

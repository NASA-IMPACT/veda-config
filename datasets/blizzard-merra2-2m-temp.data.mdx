...
name: "MERRA2 Reanalysis \u2013 2 Meter Temperature (Select Events)"
featured: false
description: MERRA2 2-meter temperature global reanalysis for three select blizzard
  events.
media:
...
infoDescription: "::markdown\n            - **Temporal Extent:** 2015 - 2100\n   \
  ...
  \ - **Data Type:** Research\n        "
layers:
- id: blizzard-merra2-2m-temp-cog_default
  ...
  sourceParams:
    ...
    maxzoom: 4
  compare:
    datasetId: blizzard-merra2-2m-temp
    layerId: cog_default

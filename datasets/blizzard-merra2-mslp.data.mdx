...
name: "MERRA2 Reanalysis \u2013 Mean Sea Level Pressure (Select Events)"
featured: false
description: MERRA2 mean sea level pressure (MSLP) global reanalysis for three select
  blizzard events.
media:
...
infoDescription: "::markdown\n            - **Temporal Extent:** 2015 - 2100\n   \
  ...
  \ - **Data Type:** Research\n        "
layers:
- id: blizzard-merra2-mslp-cog_default
  ...
  sourceParams:
    ...
    maxzoom: 4
  compare:
    datasetId: blizzard-merra2-mslp
    layerId: cog_default

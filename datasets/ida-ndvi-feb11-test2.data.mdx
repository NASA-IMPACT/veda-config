---
id: ida-ndvi-feb11-test2
name: NDVI for Pre and Post-Hurricane Ida from PlanetScope - Feb 11 Test2
featured: false
...
infoDescription: "::markdown\n            - **Temporal Extent:** 2015 - 2100\n   \
  ...
  \ - **Data Type:** Research\n        "
layers:
- id: ida-ndvi-feb11-test2-cog_default
  stacCol: ida-ndvi-feb11-test2
  ...
  sourceParams:
    ...
    maxzoom: 4
  compare:
    datasetId: ida-ndvi-feb11-test2
    layerId: cog_default

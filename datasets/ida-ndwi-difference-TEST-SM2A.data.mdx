---
id: ida-ndwi-difference-TEST-SM2A
name: NDWI Difference for Pre and Post-Hurricane Ida from PlanetScope TEST-SM2A
featured: false
...
infoDescription: "::markdown\n            - **Temporal Extent:** 2015 - 2100\n   \
  ...
  \ - **Data Type:** Research\n        "
layers:
- id: ida-ndwi-difference-TEST-SM2A-cog_default
  stacCol: ida-ndwi-difference-TEST-SM2A
  ...
  sourceParams:
    ...
    maxzoom: 4
  compare:
    datasetId: ida-ndwi-difference-TEST-SM2A
    layerId: cog_default

...
<Block>
  <div style={{ display: "flex", gap: "24px", alignItems: "flex-start" }}>
    ...
    <div style={{ flex: 1 }}>
      <Prose>
        <strong>Temporal Extent:</strong> January 1, 2001 - Ongoing<br />
        <strong>Temporal Resolution:</strong> Daily and Monthly Averages<br />
        <strong>Spatial Extent:</strong> Global<br />
        <strong>Spatial Resolution:</strong> 0.1° x 0.1°<br />
        <strong>Data Units:</strong> Grams of Carbon per square meter per day (g Carbon/m²/day)<br />
        <strong>Data Type:</strong> Research<br />
        <strong>Data Latency:</strong> Less than a year, typically 6 months<br /><br />
    ...
    <div style={{ flex: 1 }}>
      <iframe
        src="https://earth.gov/ghgcenter/api/raster/collections/micasa-carbonflux-daygrid-v1/items/micasa-carbonflux-daygrid-v1-20241231/WebMercatorQuad/map?assets=npp&rescale=0%2C8&colormap_name=purd"
        width="100%"
        height="400px"

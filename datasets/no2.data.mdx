...
usage:
  url: 'https://nasa-impact.github.io/veda-documentation/monthly-omi-no2-timeseries-stac-api.html'
  title: 'Monthly OMI NO2 time series using STAC API statistics endpoints'
media:

...
featured: false
description: Single value raster displaying the general snowfall footprint of a Panhandle
  Hooker type of mid-latitude cyclone.
media:
...
infoDescription: "::markdown\n            - **Temporal Extent:** 2015 - 2100\n   \
  ...
  \ - **Data Type:** Research\n        "
layers:
- id: blizzard-panhandle-hooker-cog_default

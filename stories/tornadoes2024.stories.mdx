...
<Block>
  <Figure>
      <Image
      src={new URL('./tornado-2024-warns-MAM.jpg', import.meta.url).href}
      alt='NWS-issued tornado warnings from March-May 2024.'
    />
    <Caption>
    All tornado warning polygons issued by the National Weather Service from March to May 2024. Central California also had six tornado warnings during this time period.
    </Caption>
  </Figure>
  <Figure>
      <Image
      src={new URL('./tornado-2024-warns-counties-MAM.jpg', import.meta.url).href}
      alt='Counties impacted by tornado warnings in March-May 2024.'
    />
    <Caption>
    All counties in the United States that were impacted by tornado warnings from March to May 2024. Central California also had nine counties impacted during this time period.
    </Caption>
  </Figure>
...
<Block>
  <Figure>
      <Image
      src={new URL('./tornado-2024-MAM-map.jpg', import.meta.url).href}
      alt='NWS-confirmed tornado tracks from March-May 2024.'
    />
    <Caption>
    All confirmed tornado tracks as reported by the National Weather Service across the eastern portion of the United States from March to May of 2024.
    </Caption>
  </Figure>
</Block> 

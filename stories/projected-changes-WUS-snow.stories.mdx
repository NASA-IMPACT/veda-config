...
media:
  src: ::file ./media/projected-changes-WUS-snow/snow-projections-median.jpg
...
<Block type='wide'>
  <Figure>
    <Image
       src={new URL("./media/projected-changes-WUS-snow/aggregated_climateDeltas.jpg", import.meta.url).href}
...
<Block>
   <Figure>
     <Image 
       src={new URL("./media/projected-changes-WUS-snow/habitat_spaghettiPlots.jpg", import.meta.url).href}
       alt="changes to thresholded habitat across elevation bands" 
      />
   </Figure>
   <Prose>

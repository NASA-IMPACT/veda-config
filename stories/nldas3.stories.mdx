...
<Block>
  ...
  <Figure>
    ...
    >
      Comparison of NLDAS 2 and NLDAS 3 for August 2020.
    </Caption> 
  </Figure>  
    ...
    <Figure>
      ...
      <Caption attrAuthor='EIS Team' attrUrl='https://www.nasa.gov/goddard/'>NLDAS-3 sample precipitation data compared to NLDAS-2 outputs.</Caption> 
    </Figure>
  The other meteorological forcing are obtained by downscaling MERRA-2 datasets (except for Shortwave Down radiation, which will use CERES/POWER data) using the methods as follows:
    <Figure>
      <Table
        dataPath='./table2_meteorological_downscaling.csv'
      />
    </Figure>

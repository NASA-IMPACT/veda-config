...
<Block>
  ...
  - [Notebook 1](https://docs.openveda.cloud/user-guide/notebooks/datasets/nldas_time_series.html) shows you how to create time series for NLDAS-3 data.
  - [Notebook 2](https://docs.openveda.cloud/user-guide/notebooks/datasets/nldas_compare2_3.html) shows you how to compare NLDAS-2 and NLDAS-3 data.
  </Prose>
</Block>

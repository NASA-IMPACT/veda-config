...
<Block>
    ...
    <Figure>
        <Image
            src={new URL('./ch4_trend_all_gl.png', import.meta.url).href}
    ...
    <Block>
        <Figure>
            <Image
                ...
                attrUrl="https://d2pn8kiwq2w21t.cloudfront.net/images/1-Permian-methane-Von-Pless-gas-flaring-photo.width-1320.jpg"
            />
    ...
    <Block>
        ...
        <Figure>
            <Image
                src={new URL('./lillies.jpeg', import.meta.url).href}

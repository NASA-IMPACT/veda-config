...
<Block type='full'>
  <Figure>
    <Map
      ...
      layerId='nightlights-hd-monthly-covid-19'
...
<Block type='full'>
  <Figure>
      <Image
        src={new URL('./changes-parking-lot.png', import.meta.url).href}
...
<Block type='full'>
  ...
  <Figure>
      <Image
        src={new URL('./changes-ports.png', import.meta.url).href}
...
<Block type='full'>
  <Figure>
      <Image
        src={new URL('./changes-heat.png', import.meta.url).href}
...
<Block type='wide'>
  <Figure>
    <CompareImage 
      leftImageSrc={new URL('./changes-surf-temp-2018-04.png', import.meta.url).href}
      leftImageAlt='Satellite view of the bay area indicating surface temperature in April 2018'
      leftImageLabel='April 2018'
      rightImageSrc={new URL('./changes-surf-temp-2020-04.png', import.meta.url).href}
...
<Block type='wide'>
  <Figure>
      <Image
        src={new URL('./changes-fires.png', import.meta.url).href}

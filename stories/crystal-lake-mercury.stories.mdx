...
media:
  src: ::file ./media/crystal-lake-mercury/crystal-lake-background-sat.jpg
...
<Block>
  ...
  <Figure>
    <video style={{ width: '100%', aspectRatio: "16/9" }} controls>
      <source
        src={new URL('./media/crystal-lake-mercury/crystal-lake-location.mp4', import.meta.url).href} type="video/mp4"
      />
...
<Block type="wide">
  <Figure>
    <Chart
      dataPath={new URL('./media/crystal-lake-mercury/crystal-lake-aod-trend.csv', import.meta.url).href}
      dateFormat="%Y-%m"
      idKey='source'
      xKey='Date'
      yKey='Mean AOD'
...
<Block type="wide">
  <Figure>
    <Chart
      dataPath={new URL('./media/crystal-lake-mercury/smoke_count_annual_with_trend.csv', import.meta.url).href}
      dateFormat="%Y"
      idKey='source'
      xKey='Year'
      yKey='smoke'
...
<Block>
  <Figure>
     <video style={{ width: '100%', aspectRatio: "16/9" }} controls>
      <source
        src={new URL('./media/crystal-lake-mercury/crystal-lake-sept2020.mp4', import.meta.url).href} type="video/mp4"
      />
      Your browser does not support the video tag.
    </video>

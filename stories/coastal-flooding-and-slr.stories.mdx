...
media:
  src: ::file ./media/coastal-flooding-and-slr/coastal-flooding-and-slr-cover.jpg
...
<Block>
  ...
  <Figure>
    <Chart
      dataPath={new URL('./media/coastal-flooding-and-slr/TWS_time_series.csv', import.meta.url).href}
      dateFormat="%b-%Y"
      idKey='type'
      xKey='date'
      yKey='TWS'
...
<Block>
  ...
  <Figure>
    <Chart
      dataPath={new URL('./media/coastal-flooding-and-slr/groundwater_time_series.csv', import.meta.url).href}
      dateFormat="%b-%y"
      idKey='type'
      xKey='date'
      yKey='groundwater'
...
<Block>
  ...
  <Figure>
    <Chart
      dataPath={new URL('./media/coastal-flooding-and-slr/coastal_land_loss_time_series.csv', import.meta.url).href}
      dateFormat="%Y"
      idKey='type'
      xKey='year'
      yKey='CLL'
...
<Block>
  ...
  <Figure>
    <Chart
      dataPath={new URL('./media/coastal-flooding-and-slr/ecco_ssh.csv', import.meta.url).href}
      dateFormat="%m/%Y"
      idKey='source'
      xKey='date'
      yKey='SSH (m)'

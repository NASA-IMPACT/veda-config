...
<Block>
    <Prose>
        ...
        Whereas a global mapper can see images of a broad area to learn about large scale emissions, and “point source” detectors focus on a much smaller field of view for high-resolution plume observations, MethaneSAT looks at regional level including an assessment of point sources to derive area emissions.

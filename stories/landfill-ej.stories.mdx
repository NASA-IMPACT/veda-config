...
<Block>
  ...
  <Figure>
      <Image
      src={new URL('./dallas_redline.jpeg', import.meta.url).href}
    />
    <Caption attrAuthor='Data.gov' attrUrl='https://catalog.data.gov/dataset/redlining-maps-from-the-home-owners-loan-corporation-1937'>

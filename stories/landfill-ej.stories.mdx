...
description: "Fill in"
media:
  src: ::file ./landfill.jpg
  alt: Garbage pile in landfill.
  author:
    name: vchal
    url: https://www.istockphoto.com/photos/landfill
pubDate: 2024-04-05
taxonomy:
  - name: Topics
    values:
...
<Block>
  <Prose>
    ...
    **Disclaimer**: This study is work in progress and not peer-reviewed results.
...
<Block>
  <Prose>
    ...
    * [CDC/ATSDR SVI Data and Documentation Download | Place and Health | ATSDR](https://www.atsdr.cdc.gov/placeandhealth/svi/data_documentation_download.html)
    ...
    ### Acknowledgements: All those who work for Environmental Justice 

...
media:
  src: ::file ./media/camp-fire-burn-scar/camp-fire-background.jpg
...
<Block>
  ...
  <Figure>
      <Image
      src={new URL('./media/camp-fire-burn-scar/camp-fire-sentinel-20181111.jpg', import.meta.url).href}
...
<Block>
  ...
  <Figure>
      <Image
      src={new URL('./media/camp-fire-burn-scar/camp-fire-sentinel-20181111-falsecolor.jpg', import.meta.url).href}
      alt='Camp Fire on November 11, 2018'
    />
    <Caption>
...
<Block>
  <Figure>
     <video style={{ width: '100%', aspectRatio: "16/9" }} controls>
      <source
        src={new URL('./media/camp-fire-burn-scar/camp-fire-perimeter-progression.mp4', import.meta.url).href} type="video/mp4"
      />
...
<Block>
  <Figure>
    <Chart
      dataPath={new URL('./media/camp-fire-burn-scar/camp-fire-ndvi.csv', import.meta.url).href}
      dateFormat="%m/%d/%Y"
      xKey='Date'
      yKey='NDVI'
      yAxisLabel='NDVI'
...
<Block>
  <Figure>
    <Chart
      dataPath={new URL('./media/camp-fire-burn-scar/camp-fire-albedo.csv', import.meta.url).href}
      dateFormat="%m/%d/%Y"
      idKey='Sources'
      xKey='Date'
      yKey='Albedo'
...
<Block>
  <Figure>
    <Chart
      dataPath={new URL('./media/camp-fire-burn-scar/camp-fire-lst-celsius.csv', import.meta.url).href}
      dateFormat="%m/%d/%Y"
      idKey='Sources'
      xKey='Date'
      yKey='LST'
...
<Block>
  ...
  <Figure>
    <video style={{ width: '100%', aspectRatio: "16/9" }} controls>
      <source
        src={new URL('./media/camp-fire-burn-scar/camp-fire-oroville-location.mp4', import.meta.url).href} type="video/mp4"
      />
      Your browser does not support the video tag.
    </video>
...
<Block>
  <Figure>
    <Chart
      dataPath={new URL('./media/camp-fire-burn-scar/camp-fire-oroville-ndti.csv', import.meta.url).href}
      dateFormat="%Y%j"
      idKey='Source'
      xKey='Date'
      yKey='NDTI'
  ...
  <Figure>
     <video style={{ width: '100%', aspectRatio: "16/9" }} controls>
      <source
        src={new URL('./media/camp-fire-burn-scar/camp-fire-oroville-ndti.mp4', import.meta.url).href} type="video/mp4"
      />
      Your browser does not support the video tag.
    </video>
...
<Prose>
  ...
  Blackford, A., U. Nair, W. R. Cotton, C. Phillips, A. Kaulfus, and B. Freitag, 2026: Land–Atmosphere Interaction Responses of Burn Scar Heat Islands: A Case Study of the 2018 Camp Fire. Bull. Amer. Meteor. Soc., 107, E446–E465, https://doi.org/10.1175/BAMS-D-24-0336.1.
</Prose>
</Block>

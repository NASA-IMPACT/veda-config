...
<Block>
  <Figure>
    ...
    <Caption>
    The expansion of the perimeter of the 2018 Camp Fire from it's inception on November 8th to 100% containment on November 25th. Note the rapid expansion of burned area within the first couple of days that the fire was active.
    </Caption>
  </Figure>
</Block>
...
<Block>
  ...
  <Figure>
      <Image
      src={new URL('./camp-fire-oroville-ndti.gif', import.meta.url).href}
      alt='Lake Oroville, CA NDTI 2017-2022'
    />
    <Caption>

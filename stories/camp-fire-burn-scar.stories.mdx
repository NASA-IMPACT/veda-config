...
<Block>
  ...
  <Figure>
    ...
    />
    <Caption>
    HLS true-color imagery from November 11th, 2018 of the Camp Fire impacting the Paradise, CA area. The thick black outline is the extent of the burn scar on November 25th, 2018 once the fire was 100% contained.
    </Caption>
  </Figure>
</Block>
...
<Block>
  ...
  <Figure>
    ...
    />
    <Caption>
    HLS false-color composite imagery from November 11th, 2018 of the Camp Fire impacting the Paradise, CA area. The thick black outline is the extent of the burn scar on November 25th, 2018 once the fire was 100% contained.
    </Caption>
  </Figure>
</Block>
...
<Block>
  <Figure>
    ...
    <Caption>
    The expansion of the perimeter of the 2018 Camp Fire from it's inception on November 8th to 100% containment on November 25th. Note the rapid expansion of burned area within the first couple of days that the fire was active. This product is satellite-derived from VIIRS thermal sensors using the FEDs algorithm, and is considered experimental. The solid black outline is the official MTBS burn scar extent from the Camp Fire.
    </Caption>
  </Figure>
</Block>
...
<Block>
  <Figure>
    <Chart
      dataPath={new URL('./camp-fire-lst.csv', import.meta.url).href}
      dateFormat="%m/%d/%Y"
      idKey='Sources'
      xKey='Date'
      yKey='LST'
      yAxisLabel='LST (Kelvin)'
      highlightStart = '11/8/2018'
      highlightEnd = '11/25/2018'
      highlightLabel = 'Camp Fire'
    />
...
<ScrollytellingBlock>
  ...
  >
    ...
    The average Normalized Difference Vegetation Index (NDVI) over the region decreased from 0.65 to 0.45 following the Camp Fire event, signifying a 30% reduction in green vegetation cover.
  </Chapter>
  ...
  >
    ...
    On average, satellite observations show that daytime land surface temperature (LST) increased by 0.47 K over the area affected by the Camp Fire event. Satellite observations also show that local changes in daytime LST within the burnscar region can reach up to 6.12 K, which implies correspondingly large increases in maximum air temperatures as well.
  ...
  >
    ...
    Satellite observations show that loss of vegetation caused by the Camp Fire event leads to an average decrease in nightime LST of 0.335 K (0.639 ⁰F).  Locally, decrease in nighgtime LST can reach up to 1.56 K. Satellite observations also show that decrease in nighttime LST is due to increase in efficiency of loss of energy from the surface in the form of infrared radiation.
  ...
  >
    ...
    Satellite observations show that there is a 5% increase in average albedo following the wildfire and thus a greater proportion of incoming sunlight reflected back by the surface.
...
<Block>
  ...
  <Figure>
    ...
    <Caption>
    HLS computed Normalized Difference Turbidity Index values over Lake Oroville, CA from 2017 to 2022. This lake is just downstream of the Camp Fire, which occurred from November 8-25th, 2018.
    </Caption>
  </Figure>
  </Prose>
</Block>

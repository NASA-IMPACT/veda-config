...
<Block>
  <Prose>
    ...
    >
      ...
      >
        <img src={new URL("./epa.svg", import.meta.url).href} alt="epa logo" />
      </figure>
      <figure
    ...
    non-public sector, NASA, EPA, NIST and NOAA. The Center acts as an
...
<Block>
  <Prose>
    ...
    following an iterative approach, which begins with input from NASA, EPA,
...
<Block>
    ...
    The US GHG Center is not a comprehensive accounting of all GHG-relevant products and datasets produced by the U.S. Federal Government. Additional features and datasets will be added as additional information is available, with links throughout the site to additional resources.
    </Prose>

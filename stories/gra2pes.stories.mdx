...
<Block type="wide">
  <Figure>
    <Embed
      height="800"
      src="https://earth.gov/ghgcenter/custom-interfaces/urban-dashboard/?dataset=GRA²PES"
    />
  </Figure>
</Block>
...
<Block>
    ...
    <Figure>
        <Map
            datasetId='GRA²PES-ghg-monthgrid-v1'
            layerId='co2'
            dateTime='2021-12-01'
        ...
        />
        <Caption>
            GRA²PES geospatial data allows researchers to examine and better understand air quality and greenhouse gas pollution sources at a local level. Shown here over New York City in December 2021, carbon dioxide (CO₂) and nitrogen oxides (NO₂) are both byproducts of fossil fuel burning.
        </Caption>
    </Figure>
    </Block>
    <Block>
...
<Block>
    <Prose>
        ...
        - Detailed information on the dataset: <Link to="/data-catalog/GRA²PES-ghg-monthgrid-v1">GRA²PES Greenhouse Gas and Air Quality Species</Link>
        - Explore the data in the <Link to="/exploration?search=GRA²PES-ghg-monthgrid-v1">GRA²PES customizable interactive map</Link>
    </Prose>
</Block>

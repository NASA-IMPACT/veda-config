...
media:
  src: ::file ./media/fire-life-cycle/fire-cover.png
...
<Block>
  <Figure>
    <Image
      src={new URL("./media/fire-life-cycle/dixie_burn_2.png", import.meta.url).href}
...
<Block type="wide">
  <Figure>
    <Chart
      dataPath={new URL('./media/fire-life-cycle/Burnarea_timeseries_WUS.csv', import.meta.url).href}
      dateFormat="%Y"
      idKey='source'
      xKey='year'
...
<Block>
  <Figure>
     <video style={{ width: '100%', aspectRatio: "16/9" }} controls>
      <source
        src={new URL('./media/fire-life-cycle/fire_hyro_VIZ01_final_HD_1080p59.94.mp4', import.meta.url).href} type="video/mp4"
      />
...
<Block>
  ...
  <Figure>
    <Image
      src={new URL("./media/fire-life-cycle/cv_irrig.jpeg", import.meta.url).href}
...
<ScrollytellingBlock>
  ...
  >
    ...
    <Chart
      dataPath={new URL('./media/fire-life-cycle/ET_timeseries_PreacherNV.csv', import.meta.url).href}
      dateFormat="%m/%d/%y"
      idKey='source'
      xKey='Date'
      yKey='ET (mm)'
  ...
  >
    ...
    <Chart
      dataPath={new URL('./media/fire-life-cycle/ET_timeseries_NatchezCA.csv', import.meta.url).href}
      dateFormat="%m/%d/%y"
      idKey='source'
      xKey='Date'
      yKey='ET (mm)'
  ...
  >
    ...
    <Chart
      dataPath={new URL('./media/fire-life-cycle/ET_timeseries_ThomasCA.csv', import.meta.url).href}
      dateFormat="%m/%d/%y"
      idKey='source'
      xKey='Date'
      yKey='ET (mm)'
...
<Block>
  ...
  <Figure>
    <Image
      src={new URL("./media/fire-life-cycle/frp_barc_plot.png", import.meta.url).href}

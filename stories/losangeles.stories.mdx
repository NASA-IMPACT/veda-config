...
isHidden: false
media:
  src: ::file ./media/los_angeles_banner.png
  alt: Los Angeles
  author:
...
<Block>
  ...
  <Figure>
        <Image 
          ...
          caption="Satellite-based observations allow scientists to pinpoint sources of carbon dioxide emissions associated with the burning of fossil fuels, including industrial areas and shipping ports. " 
          width="600"
        />
  </Figure>
</Block>
...
<Block>
    <Prose>
        ...
        - Detailed information on NIST’s Los Angeles Megacities (LAM) dataset: <Link to="/data-catalog/lam-testbed-ghg-concentrations">LAM Dataset Overview</Link>
    </Prose>

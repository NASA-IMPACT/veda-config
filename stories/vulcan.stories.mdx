...
<Block>
  <Figure>
    ...
    />
    <Caption>
      Scope 1 (left) VS Scope 2 (right) residential fossil fuel CO₂ emissions (2021) for Phoenix, Arizona
    </Caption>
  </Figure>
</Block>
...
<Block>
  <Figure>
    ...
    />
    <Caption>
      Scope 1 (left) VS Scope 2 (right) residential fossil fuel CO₂ emissions (2021) for Minneapolis, Minnesota
    </Caption>
  </Figure>
</Block>

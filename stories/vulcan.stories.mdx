...
<Block>
    ...
    Detailed information on the dataset: <SmartLink to="/data-catalog/vulcan-ffco2-yeargrid-v4">Vulcan 4.0 Dataset Overview</SmartLink>
    Explore the data in our customizable interactive map: <SmartLink to="/exploration?search=vulcan-ffco2-yeargrid-v4">Vulcan 4.0 Map Exploration</SmartLink>
    </Prose>

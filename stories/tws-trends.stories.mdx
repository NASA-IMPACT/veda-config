...
media:
  src: ::file ./media/tws-trends/jordan_image.jpg
...
<Block>
    <Figure>
    <Chart
      dataPath={new URL('./media/tws-trends/SouthAsia_TWS_annual_data.csv', import.meta.url).href}
      dateFormat="%Y"
      idKey='Data Type'
      xKey='Year'
    ...
    />
     ...
     <Chart
       dataPath={new URL('./media/tws-trends/SouthAsia_GPP_annual_data.csv', import.meta.url).href}
       dateFormat="%Y"
       idKey='Data Type'
       xKey='Year'
       yKey='GPP'
    ...
    <Chart
      dataPath={new URL('./media/tws-trends/SouthAsia_ET_annual_data.csv', import.meta.url).href}
      dateFormat="%Y"
      idKey='Data Type'
      xKey='Year'
      yKey='Water Components'

...
media:
  src: ::file ./media/blizzards/blizzards-cover.png
...
<ScrollytellingBlock>
  ...
  <Figure>
    <Image
      src={new URL('./media/blizzards/blizzard-art-conditions.gif', import.meta.url).href}
  ...
  * Frequent Storm Systems: Low-pressure systems often develop east of the Rocky Mountains, intensifying as they move into the Plains, bringing heavy snowfall and high winds. 
  ...
  <Figure>
    <Image
      src={new URL('./media/blizzards/blizzards-climo-1959-2014.png', import.meta.url).href}
  ...
  A notable event during this historic blizzard was the infamous ‘Snow Bowl’. The Snow Bowl was the  annual edition of ‘The Game’ - the Ohio State-Michigan football game, played on November 25 in Columbus, Ohio. Under heavy snowfall and freezing winds, players and fans braved the elements as snowplows were used to clear the field mid-game. The extreme weather rendered passing nearly impossible, and Michigan was able to pull out a 9-3 win. This edition of ‘The Game’ remains one of the most memorable contests ever played in all of collegiate athletics.
   ...
   <Figure>
    <Image
      src={new URL('./media/blizzards/blizzards-1950-the-game.png', import.meta.url).href}
  ...
  <Figure>
    <Image
      src={new URL('./media/blizzards/Blizzard78_ShelbyCo_Shoveling.png', import.meta.url).href}
  ...
  <Figure>
    <Image
      src={new URL('./media/blizzards/Blizzard78_I75.png', import.meta.url).href}
  ...
  <Figure>
    <Image
      src={new URL('./media/blizzards/Blizzard78_Drift_UnionCity_Beamsville_Rd.png', import.meta.url).href}
  ...
  <Figure>
    <Image
      src={new URL('./media/blizzards/Blizzard78_Sidney_Aerial.png', import.meta.url).href}
  ...
  <Figure>
    <Image
      src={new URL('./media/blizzards/Blizzard78_ShelbyCo_Road_Truck.png', import.meta.url).href}
  ...
  <Figure>
    <Image
      src={new URL('./media/blizzards/Blizzard78_BeforeAfter_House_PascoMontra.png', import.meta.url).href}
  ...
  <Figure>
    <Image
      src={new URL('./media/blizzards/blizzards-1991-goes.gif', import.meta.url).href}
  ...
  <Figure>
    <Image
      src={new URL('./media/blizzards/blizzards-1993-goes-Storm-of-the-Century.gif', import.meta.url).href}
  ...
  <Figure>
    <Image
      src={new URL('./media/blizzards/blizzards-2016-jonas-snowpack.png', import.meta.url).href}
...
<Block>
  ...
  <Figure>
    <Image
      src={new URL('./media/blizzards/Blizzard78_WestMilton_Snow.png', import.meta.url).href}
...
<Block>
  <Figure>
    <Image
      src={new URL('./media/blizzards/blizzards-burst-pipe.jpeg', import.meta.url).href}

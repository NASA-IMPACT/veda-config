...
media:
  src: ::file ./media/houston-aod/steam-power-plant.png
...
<ScrollytellingBlock>
  ...
  >
    ...
    <Chart
      dataPath={new URL('./media/houston-aod/baytown_adjusted.csv', import.meta.url).href}
      dateFormat="%Y-%m"
      idKey='source'
      xKey='Date'
      yKey='Mean AOD'
  ...
  >
    ...
    <Chart
      dataPath={new URL('./media/houston-aod/west_houston_adjusted.csv', import.meta.url).href}
      dateFormat="%Y-%m"
      idKey='source'
      xKey='Date'
      yKey='Mean AOD'
  ...
  >
    ...
    <Chart
      dataPath={new URL('./media/houston-aod/Houston_IAH.csv', import.meta.url).href}
      dateFormat="%Y-%m"
      idKey='source'
      xKey='Date'
      yKey='Mean AOD'

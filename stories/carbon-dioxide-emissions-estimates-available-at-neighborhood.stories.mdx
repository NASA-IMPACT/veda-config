...
media:
  src: "https://images.unsplash.com/photo-1582377224944-2c2a17affa38?q=80&w=1471&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
  alt: white smoke coming out from building
  author:
    name: Marcin Jozwiak
    url: "https://unsplash.com/photos/white-smoke-coming-out-from-building-YGPCYETKFw8"
pubDate: 2024-09-04
featured: false
---
...
<Block>
  <Prose>
    ...
    The Vulcan Project began in 2004 with grants from NASA, and later from the National Science Foundation and NOAA. The goal was to explore a basic question in carbon cycle science: Where do atmospheric greenhouse gases come from? Gurney wanted to quantify how the biosphere, Earth’s zone of life, exchanges CO₂. To do that needed to estimate where, and how much, people were burning fossil fuels.
...
<Block>
    ...
    Detailed information on the dataset. Explore the data in our customizable interactive map.
    </Prose>

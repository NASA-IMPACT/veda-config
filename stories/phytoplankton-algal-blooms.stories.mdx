...
media:
  src: ::file ./media/phytoplankton-algal-blooms/phytoplankton-algal-blooms--discovery-cover.jpg
...
<Block>
  ...
  <Figure>
    <Image
      src={new URL('./media/phytoplankton-algal-blooms/lake-erie.jpg', import.meta.url).href}
...
<Block>
  <Figure>
    <Image
      src={new URL('./media/phytoplankton-algal-blooms/cyan-product.png', import.meta.url).href}
...
<Block>
  <Figure>
    <CompareImage 
      leftImageSrc={new URL('./media/phytoplankton-algal-blooms/ocean-true-color.png', import.meta.url).href}
      leftImageAlt='True color lake view from satellite'
      leftImageLabel='True color'
      rightImageSrc={new URL('./media/phytoplankton-algal-blooms/ocean-cyan.png', import.meta.url).href}

...
<Block>
    ...
    <Image
      ...
      alt='(Top) Drought conditions in the state of Texas leading up to the July 4th, 2025 flash flood. Kerr County is one of two counties in the state to have 100% coverage of D4 exceptional drought conditions. (Bottom) Time series of the percentage coverage of each drought category in Kerr County, 2000-2025.'
      attrAuthor = 'US Drought Monitor'
      attrUrl = 'https://droughtmonitor.unl.edu/CurrentMap/StateDroughtMonitor.aspx?fips_48019'
    />
    <Caption>
    (Top) Drought conditions in the state of Texas leading up to the July 4th, 2025 flash flood. Kerr County is one of two counties in the state to have 100% coverage of D4 exceptional drought conditions. (Bottom) Time series of the percentage coverage of each drought category in Kerr County, 2000-2025.    </Caption>
    </Figure>
</Block>

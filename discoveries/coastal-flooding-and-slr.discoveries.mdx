...
name: Risks to coasts from from sea level rise compounded by water cycle intensification
...
<Block>
   <Prose>
    ...
    https://github.com/dfelikson/veda-data-processing/blob/main/ECCO_NetCDF_to_COG/create_ECCO_SSH_timeseries.ipynb
  </Prose>
  <Figure>
    <Chart

...
<Block type="full">
  <Figure>
    <Map
      datasetId='nlcd'
      layerId='camp-fire-hls'
      dateTime='2016-01-01'
      compareDateTime='2019-01-01'
    />
    <Caption>
      Figure 1. Harmonized Landsar-Sentinel satellite imagery of the Camp Fire domain before and after the fire.
    </Caption>
  </Figure>
*/
...
<Block type="full">
  <Figure>
    <Map
      datasetId='nlcd'
      layerId='camp-fire-landcover'
      dateTime='2016-01-01'
      compareDateTime='2019-01-01'
    />
    <Caption>
      Figure 2. National Land Cover Databse classification of the Camp Fire domain between 2016 and 2019. For a full list of land cover classes, see the class legend and descriptions [here](https://www.mrlc.gov/data/legends/national-land-cover-database-class-legend-and-description).
    </Caption>
  </Figure>
*/

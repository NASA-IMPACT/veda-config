...
<Block>
  <Prose>
    ...
    [Explore interactive JupyterHub notebook] (https://nasa-veda.2i2c.cloud/hub/user-redirect/lab/tree/eis-notebooks/FIRE_HYDRO/fire-life-cycle-DisALEXI.ipynb) for impacts using ET observations
  </Prose>
</Block>
...
<Prose>
    ...
    [Explore interactive JupyterHub notebook] (https://nasa-veda.2i2c.cloud/hub/user-redirect/lab/tree/eis-notebooks/FIRE_HYDRO/fire-life-cycle-DisALEXI.ipynb) for impacts using LIS-derived outputs.
...
<Figure>
  ...
  <Caption
    ...
    attrUrl='https://nasa.gov/'
  >
    Change in modeled ET (left) compared with MTBS severity maps for 2020 fire season. Zoom in for a closer look at these burned areas.
  </Caption>
</Figure>
</Block>
...
<Figure>
  ...
  <Caption
    ...
    attrUrl='https://nasa.gov/'
  >
    Change in modeled transpiration (left) compared with MTBS severity maps for 2020 fire season. Zoom in for a closer look at these burned areas.
  </Caption>
</Figure>
</Block>

...
<Block type='full'>
  <Figure>
    <Map
      datasetId='tws-nonstationarity-index'
      layerId='tws-nonstationarity-index'
      dateTime='2003-01-01'
      zoom={1}
      center={[0,0]}
    />
  ...
  <Prose>
    ## TWS Non-Stationarity Index
    The global Terrestrial Water Storage (TWS) non-stationarity index integrates the trend, seasonal shifts, and variability change of TWS for the period of 2003 - 2020.
  </Prose>  
 </Block>

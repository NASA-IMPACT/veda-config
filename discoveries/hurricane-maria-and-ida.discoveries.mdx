...
<Block>
  ...
  <Figure>
    <Chart
      dataPath={new URL('./hurricane-maria-ida-chart2.csv', import.meta.url).href}
      dateFormat="%m/%Y" 
      idKey='Zip' 
      xKey='Month' 
      yKey='Number of Tarps' 
...
<Block>
  <Figure>
    <Chart
      dataPath={new URL('./hurricane-maria-ida-chart3.csv', import.meta.url).href}
      dateFormat="%m/%Y" 
      idKey='Zip' 
      xKey='Month' 
...
<Block>
  <Figure>
    <Chart
      dataPath={new URL('./hurricane-maria-ida-chart4.csv', import.meta.url).href}
      dateFormat="%m/%Y" 
      idKey='Zip' 
      xKey='Month' 
      yKey='Percentage of Buildings' 

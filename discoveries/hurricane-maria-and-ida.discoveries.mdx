...
<Block type='full'>
  <Prose>
    ...
    **Additional Resources**
    ...
    NASA Features
    https://www.earthobservatory.nasa.gov/images/144371/night-lights-show-slow-recovery-from-maria
    https://earthobservatory.nasa.gov/images/148777/satellite-observes-power-outages-in-new-orleans
  </Prose>
  <Figure>
    <Map
...
<Block>
  <Figure>
    ...
    <Caption 
      ...
      attrUrl='https://nasa.gov/'
    >
      Tarps as a percentage of the total buildings in the aftermath of Hurricane Ida
    </Caption> 
  </Figure>
</Block>
...
<Block>
  <Figure>
    ...
    <Caption 
      ...
      attrUrl='https://nasa.gov/'
    >
      Tarps as a percentage of the total buildings in the aftermath of Hurricane Maria
    </Caption> 
  </Figure>
</Block>
